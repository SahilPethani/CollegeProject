...
import { allProject, deleteProject, getProject } from "../../../services/project";
...
const AllProject = () => {
    ...
    const [deleteProjectId, setDeleteAddOnId] = useState(0);
    ...
    const editProject = useCallback(
        (id) => () => {
            navigate(`/admin/projects/editproject/${id}`);
        },
        []
    );
                ...
                <Box>
                    ...
                    >
                        ...
                        <Box sx={{ display: "flex", gap: "10px" }}>
                            <IconButton
                                onClick={() => navigate(Routing.AddProjects)}
                                aria-label="delete"
                                size="medium"
                                sx={{
                    ...
                    bodyContent={
                        <Box>
                            <Grid container spacing={2} padding="20px" alignItems="center">
                                ...
                                <Grid item xs={6}>
                                    <Typography fontSize={14} fontWeight={500}>Price</Typography>
                                    <Typography fontSize={14} color={"#00000099"} fontWeight={400}>{projectData?.price}</Typography>
                                </Grid>
                                <Grid item xs={6}>
                                    <Typography fontSize={14} fontWeight={500}>Project Priority</Typography>
                                    <Typography fontSize={14} color={"#00000099"} fontWeight={400}>{projectData?.project_priority}</Typography>
                                </Grid>
                                <Grid item xs={6}>
